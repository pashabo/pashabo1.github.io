...
$(function(){$(".popup-form").submit(function(){var e=$(this);return $.ajax({type:"POST",url:"mail.php",data:e.serialize()}).done(function(){$(".success").addClass("visible"),setTimeout(function(){e.trigger("reset"),$(".success").removeClass("visible"),$.magnificPopup.close()},3e3)}),!1}),$(".popup-with-move-anim").magnificPopup({type:"inline",fixedContentPos:!1,fixedBgPos:!0,overflowY:"auto",closeBtnInside:!0,preloader:!1,midClick:!0,removalDelay:300,mainClass:"my-mfp-slide-bottom"});var e=new Scroller({el:document.querySelector(".scr")});setTimeout(function(){$(".product").animate({opacity:1},500),e.scrollTo("end",500)},500);var o=$("#anchors-chk"),n=$("#scrollbar-chk");o.on("change",function(n){var t=!o.prop("checked");e.update({noAnchors:t})}),n.on("change",function(o){var t=!n.prop("checked");e.update({noScrollbar:t})}),$(document).ready(function(){$(".portmnu").on("click","a",function(e){e.preventDefault();var o=$(this).attr("href"),n=$(o).offset().top;$("body,html").animate({scrollTop:n},1500)})})});